...
COMPATIBLE_MACHINE =. "|cetibox-h3ulcb|cetibox-vc2"
...
ATFW_OPT_append_cetibox-vc2 = " RCAR_SYSTEM_SUSPEND=0"
...
python do_extra_ipl_opt_append() {
    if soc == "r8a7795":
        ...
        d.setVar('EXTRA_ATFW_OPT', ' LSI=H3 RCAR_DRAM_SPLIT=1 RCAR_DRAM_LPDDR4_MEMCONF=0 RCAR_SYSTEM_SUSPEND=0')
        d.setVar('EXTRA_ATFW_OPT_append_ulcb', '')
